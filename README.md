# Домашнее задание к занятию «Основы Git» Лычагин Н.В.
...
![1](https://github.com/Nikich828/devops-netology/blob/fix/1.jpeg)
...
![1](https://github.com/Nikich828/devops-netology/blob/fix/19.jpeg)
7. Из-за того, что это будет наш дополнительный репозиторий, ни один вариант из перечисленных в инструкции (на странице 
вновь созданного репозитория) нам не подходит. Поэтому добавляем этот репозиторий, как дополнительный `remote`, к созданному
репозиторию в рамках предыдущего домашнего задания:
`git remote add gitlab https://gitlab.com/YOUR_LOGIN/devops-netology.git`.

![1](https://github.com/Nikich828/devops-netology/blob/fix/4.png)
8. Отправьте изменения в новый удалённый репозиторий `git push -u gitlab main`.

![1](https://github.com/Nikich828/devops-netology/blob/fix/5.jpeg)

9. Обратите внимание, как изменился результат работы команды `git remote -v`.

![1](https://github.com/Nikich828/devops-netology/blob/fix/6.jpeg)
...
![1](https://github.com/Nikich828/devops-netology/blob/fix/7.jpeg)

2. Аналогично создайте аннотированный тег `v0.1`.

![1](https://github.com/Nikich828/devops-netology/blob/fix/20.jpeg)
...
![1](https://github.com/Nikich828/devops-netology/blob/fix/8.jpeg)
![1](https://github.com/Nikich828/devops-netology/blob/fix/9.jpeg)

Аннотировнный более инмформативный, чем легковесный.
...
![1](https://github.com/Nikich828/devops-netology/blob/fix/10.jpeg)

4. Создайте новую ветку `fix`, базируясь на этом коммите `git switch -c fix`.
5. Отправьте новую ветку в репозиторий на GitHub `git push -u origin fix`.

![1](https://github.com/Nikich828/devops-netology/blob/fix/11.jpeg)

6. Посмотрите, как визуально выглядит ваша схема коммитов: https://github.com/YOUR_ACCOUNT/devops-netology/network. 

![1](https://github.com/Nikich828/devops-netology/blob/fix/12.jpeg)

7. Теперь измените содержание файла `README.md`, добавив новую строчку.
8. Отправьте изменения в репозиторий и посмотрите, как изменится схема на странице https://github.com/YOUR_ACCOUNT/devops-netology/network 
и как изменится вывод команды `git log`.

![1](https://github.com/Nikich828/devops-netology/blob/fix/13.jpeg)
![1](https://github.com/Nikich828/devops-netology/blob/fix/21.jpeg)
![1](https://github.com/Nikich828/devops-netology/blob/fix/14.jpeg)
...
![1](https://github.com/Nikich828/devops-netology/blob/fix/16.jpeg)
![1](https://github.com/Nikich828/devops-netology/blob/fix/17.jpeg)
![1](https://github.com/Nikich828/devops-netology/blob/fix/18.jpeg)

Ссылки на репозитории:
https://github.com/Nikich828/devops-netology/tree/fix
